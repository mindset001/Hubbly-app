  ...
  return (
    <main className='w-full flex flex-col items-center my-10'>
        ...
        <div className='text-center'>
                ...
                <h1 className={`${rale.className} capitalize text-[60px] font-[700]  mb-2 text-[#048392]`}>one stop home service</h1>
            ...
            <div className='grid grid-cols-4 gap-2  text-[16px] font-[400] w-[80%] mt-6'>
                    {Navcontent.map((item, i: number) => (
                       
                            <div className='flex flex-col items-center mt-4'>
                            <Image src={item.img} alt='' className='w-[164px] h-[164px]' />
                                <p className='text-[18px] font-[700] mt-2'>{item.name}</p>
