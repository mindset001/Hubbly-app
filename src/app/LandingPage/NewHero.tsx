    ...
    return (
        <main className='hero w-full flex flex-col items-center text-[#fff]'>
            ...
            <div className='w-[80%] '>
                ...
                {hide && <div className='bg-white p-6 absolute right-2 top-12 block lg:hidden mt-6'>
                ...
                <div className='flex flex-col lg:flex-row justify-between mt-10'>
                    <div>
                        ...
                        <h1 className='font-[700] text-[35px] md:text-[50px] lg:text-[60px]'>All Your Home <br />
